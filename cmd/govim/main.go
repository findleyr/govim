...
func (g *govimplugin) defineHighlights() {
	...
	for _, hi := range []string{
		fmt.Sprintf("highlight default %s term=underline cterm=underline gui=undercurl ctermfg=1 guisp=Red", types.HighlightErr),
		fmt.Sprintf("highlight default %s term=underline cterm=underline gui=undercurl ctermfg=%d guisp=Orange", types.HighlightWarn, warnColor),
		fmt.Sprintf("highlight default %s term=underline cterm=underline gui=undercurl ctermfg=6 guisp=Cyan", types.HighlightInfo),
		fmt.Sprintf("highlight default link %s %s", types.HighlightHint, types.HighlightInfo),

		fmt.Sprintf("highlight default link %s ErrorMsg", types.HighlightSignErr),
		fmt.Sprintf("highlight default %s ctermfg=15 ctermbg=%d guisp=Orange guifg=Orange", types.HighlightSignWarn, warnColor),
		fmt.Sprintf("highlight default %s ctermfg=15 ctermbg=6 guisp=Cyan guifg=Cyan", types.HighlightSignInfo),
		fmt.Sprintf("highlight default link %s %s", types.HighlightSignHint, types.HighlightSignInfo),
	} {
