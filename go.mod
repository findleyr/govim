...
replace golang.org/x/tools => github.com/myitcvforks/tools v0.0.0-20191214162001-758e20ac67bf

replace golang.org/x/tools/gopls => github.com/myitcvforks/tools/gopls v0.0.0-20191214162001-758e20ac67bf
